function phase1_inter_patient_analysis()
    ...
    % Search recursively for all PNG or JPG images
    ...
    fprintf('Found %d images. Processing first %d images in Lab space...\n', totalFound, numImages);
...
% =========================================================================
% HELPER FUNCTIONS FOR CIE L*a*b* (?? ?????)
% =========================================================================
